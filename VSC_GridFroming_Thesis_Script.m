...
% % %Paquette Values
% R_v_pu=0.0707; %[pu] 
% L_v_pu=(R_v_pu)/(2*pi*f_b);  %virtual inductance
% 
% R_v=R_v_pu*Z1_b; %virtual resistance 
% L_v=L_v_pu*L1_b;  %virtual inductance

%Original  WORKING AND REACHING GOOD PEAK VALUES
% R_v_pu=1.5; %[pu] 
% L_v_pu=(XR*R_v_pu*100)/(2*pi*f_b);  %virtual inductance
% R_v_pu=0.5; %[pu] 
% L_v_pu=1.5;  %virtual inductance
% 
% 
% R_v=R_v_pu*Z1_b; %virtual resistance 
% L_v=L_v_pu*L1_b;  %virtual inductance

% %Without VI trandient
% R_v_pu=0; %[pu] 
% L_v_pu=(XR*R_v_pu*100)/(2*pi*f_b);  %virtual inductance
% 
% R_v=R_v_pu*Z1_b; %virtual resistance 
% L_v=L_v_pu*L1_b;  %virtual inductance
% 
% % %MIGRATE/Norway VALUES
% R_v_pu=0.1; %[pu] 
% L_v_pu=0.2;  %virtual inductance
% 
% R_v=R_v_pu*Z1_b; %virtual resistance 
% L_v=L_v_pu*L1_b;  %virtual inductance
